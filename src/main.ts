...
class Mouse {
    position: IPosition = { x: 7, y: 7 };
    collision: Boolean = false;

    random(gameAreaWidth: number, gameAreaHeight: number, snake: Snake) {
        do {
...
TERM.on('key', function (name: any, matches: any, data: any) {
